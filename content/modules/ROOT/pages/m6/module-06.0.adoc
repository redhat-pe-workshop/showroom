...
So far, as Platform Engineers, we have provided our developers with templates to start new development activities as well as straightforward means to contribute to existing projects, inluding ephermal development environments on our cluster.
...
* Adding container image scanning capabilities to our Continuous Intergartion (CI) flow
